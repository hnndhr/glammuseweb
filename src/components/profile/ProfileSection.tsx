  ...
  useEffect(() => {
    if (personalInfo) {
      ...
      if (personalInfo.profilePicture) {
        setProfileImagePreview(personalInfo.profilePicture);
      }
    }
  }, [personalInfo]);
    ...
    <section className="w-full max-w-[1362px] mt-[59px] max-md:max-w-full max-md:mt-10">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch h-full">
        <article className="w-[36%] max-md:w-full max-md:ml-0">
          <div className="bg-white shadow-[3px_3px_4px_rgba(0,0,0,0.25)] border relative min-h-[494px] text-[40px] text-tertiary text-center w-full pt-[15px] pb-[46px] px-[49px] rounded-[20px] border-[rgba(74,59,48,0.7)]">
        ...
        <article className="w-[64%] ml-5 max-md:w-full max-md:ml-0">
          <div className="bg-white shadow-[3px_3px_4px_rgba(0,0,0,0.25)] border flex flex-col pt-[15px] pb-[79px] px-[52px] rounded-[20px] border-[rgba(74,59,48,0.7)]">
