...
export default function SkinTypeResults() {
  ...
  const skinType = searchParams.get("type") || "normal";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="py-8 px-6 lg:px-48">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] rounded-[20px] border border-[#4A3B30] border-opacity-70 bg-white shadow-lg overflow-hidden">
                <Image
          ...
          <div className="space-y-6 text-black font-manrope text-justify">
            <h2 className="text-2xl md:text-3xl font-bold leading-[150%] tracking-[0.4px]">
              You Have {data.title} Skin — {skinType === "normal" ? "Lucky You!" : "Here's What You Need to Know!"}
            </h2>
