  ...
  const calculateBodyType = (): { type: string; description: string } => {
    ...
    if (
      ...
      return {
        type: "Hourglass",
        description:
          "You have a classic hourglass figure with balanced bust and hips and a well-defined waist.",
      };
    }
    ...
    if (
      ...
      return {
        ...
        description:
          "You have a bottom hourglass figure with fuller hips than bust, creating a pear-like hourglass silhouette.",
      };
    }
    ...
    if (bustMinusHips > 1 && bustMinusHips < 10 && bustMinusWaist >= 9) {
      return {
        type: "Top Hourglass",
        description:
          "You have a top hourglass figure with a fuller bust than hips and a defined waist.",
      };
    }
    ...
    if (
      ...
      return {
        type: "Spoon",
        description:
          "You have a spoon body shape with fuller hips and a defined waist.",
      };
    }
    ...
    if (hipsMinusBust >= 3.6 && hipsMinusWaist < 9) {
      return {
        type: "Triangle",
        description:
          "You have a triangle (pear) body shape with hips wider than your bust.",
      };
    }
    ...
    if (bustMinusHips >= 3.6 && bustMinusWaist < 9) {
      return {
        ...
        description:
          "You have an inverted triangle body shape with broader shoulders and bust than hips.",
      };
    }
    ...
    if (
      ...
      return {
        type: "Rectangle",
        description:
          "You have a rectangle body shape with similar measurements across bust, waist, and hips.",
      };
    }
    ...
    return {
      type: "Rectangle",
      description:
        "Based on your measurements, you have a rectangle body shape with balanced proportions.",
    };
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-full max-w-[844px] mx-auto mb-8 p-[52px] border border-glam-tertiary/70 rounded-[20px] bg-white shadow-lg">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              {/* Body Diagram */}
              <div className="flex-shrink-0 relative w-[326px] h-[381px] rounded-lg overflow-hidden">
                <Image
          ...
          <div className="text-black font-manrope text-[20px] font-normal leading-[150%] tracking-[0.4px] text-justify space-y-6">
            <div>
              ...
              <p className="mb-4">
                ...
                you&rsquo;re styling virtually or in person.
              </p>
              <p className="mb-6">
